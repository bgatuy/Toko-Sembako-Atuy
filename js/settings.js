...
export function loadSettings() {
  ...
  if (document.getElementById("sidebarStoreName"))
    document.getElementById("sidebarStoreName").textContent =
...
export function renderSettings() {
  ...
  document.getElementById("settingStoreAddress").value =
    appSettings.storeAddress;
  if (document.getElementById("settingLowStockLimit"))
    document.getElementById("settingLowStockLimit").value =
      appSettings.lowStockLimit || 10;
  if (document.getElementById("settingReceiptHeader"))
    document.getElementById("settingReceiptHeader").value =
      appSettings.receiptHeader || "";
  if (document.getElementById("settingReceiptFooter"))
    document.getElementById("settingReceiptFooter").value =
      appSettings.receiptFooter || "";
  if (document.getElementById("settingReceiptLogo"))
    document.getElementById("settingReceiptLogo").value = "";
}
...
export function saveSettings() {
  ...
  const lowStockLimit =
    parseInt(document.getElementById("settingLowStockLimit").value) || 1;
  ...
  function finishSave(logoData) {
    appSettings = {
      ...
      receiptFooter,
      receiptLogo:
        logoData !== undefined ? logoData : appSettings.receiptLogo || "",
    };
    saveToStorage("appSettings", appSettings);
    if (document.getElementById("sidebarStoreName"))
