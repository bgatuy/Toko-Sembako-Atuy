...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (document.getElementById("prodPrice"))
    Helpers.setupCurrencyInput(document.getElementById("prodPrice"));
  if (document.getElementById("prodCapitalPrice"))
    Helpers.setupCurrencyInput(document.getElementById("prodCapitalPrice"));
  if (document.getElementById("prodPriceBig"))
    Helpers.setupCurrencyInput(document.getElementById("prodPriceBig"));
  if (document.getElementById("prodCapitalPriceBig"))
    Helpers.setupCurrencyInput(document.getElementById("prodCapitalPriceBig"));
  if (document.getElementById("prodPriceMedium"))
    Helpers.setupCurrencyInput(document.getElementById("prodPriceMedium"));
  if (document.getElementById("prodCapitalPriceMedium"))
    Helpers.setupCurrencyInput(
      document.getElementById("prodCapitalPriceMedium"),
    );
  ...
  if (discountType)
    discountType.addEventListener("change", Cart.updateCartTotals);
  if (searchInput)
    searchInput.addEventListener("input", Product.renderProducts);
  if (prodSearchInput)
    prodSearchInput.addEventListener("input", Product.renderProductManagement);
  if (prodSortInput)
    prodSortInput.addEventListener("change", Product.renderProductManagement);
